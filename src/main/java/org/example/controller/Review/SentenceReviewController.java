...
public class SentenceReviewController {
    ...
    public void Showindex(int index){
        try {
            ...
            lbSentence.setText(vocabulary.getExample());
    ...
    public void showColorCorrect(){
        try {
            String answercorrect = reviewList.get(indexreview).getExampleMeaning();
    ...
    public void CheckAnswer(Button btn){
        try {
            ...
            if (answer.equals(reviewList.get(indexreview).getExampleMeaning())) {
